...
/**
 * ConsultarDiagnosticosPorNombre
 * 
 * @author Vanessa Maria Duno
 * @version 1.0
 */
public class ConsultarDiagnosticosPorNombre extends CGenerico {
	...
	public List<Diagnostico> consultarDiagnosticos(String nombreDiagnostico) {
		...
		try {
			con = Conexion(); 
			String querySql = "select id_diagnostico, codigo_cie, nombre, padre,hoja from diagnostico where upper(nombre) like ? and hoja = true;";
